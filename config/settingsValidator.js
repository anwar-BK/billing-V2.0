...
const VALIDATION_RULES = {
  ...
  whatsapp_auto_billing_days_before_isolir: {
    type: 'number',
    min: 0,
    max: 31,
    description: 'Hari pengingat sebelum isolir'
  },
  whatsapp_temporary_active_reminder_days: {
    type: 'number',
    min: 0,
    max: 31,
    description: 'Hari pengingat sebelum aktif sementara berakhir'
  },
